...
const nextConfig = {
  reactStrictMode: true,
    ...
    async redirects() {
      ...
      { source: '/post/ai-automation-amp-outreach-in-2026-how-tools-like-marblism-and-salesrobot-are-changing-the-game', destination: '/blog', permanent: true },
      { source: '/blog/ai-automation-outreach-2026-marblism-salesrobot', destination: '/blog', permanent: true },
      { source: '/blog/marblism-business-automation-review', destination: '/blog', permanent: true },
      ...
      { source: '/post/testing-marblism-39-s-promise-of-complete-business-automation-a-positive-review-with-my-favorite-a', destination: '/blog', permanent: true },
