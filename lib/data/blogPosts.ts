...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    excerpt: "Not a pitch, a sequence. Month one finds the real bottleneck. Month two fixes only that. Month three builds the scoreboard. What an owner should see at each checkpoint, and what to be suspicious of if they do not.",
  ...
  },
  {
    ...
    excerpt: "The title has no licensing body, so the sorting is on you. Nine questions that separate a senior operator from a consultant with a new LinkedIn headline, including the one about who owns the number if it misses.",
    category: 'Fractional CMO',
  },
  {
    ...
    excerpt: "Thirty locations or 300, the problem is rarely content. It is that nobody has decided who is allowed to decide what. How a fractional CMO seat handles decision rights, the national-versus-local budget split, vendor oversight, and a scoreboard by location.",
    category: 'Fractional CMO',
  },
  {
    ...
    excerpt: "What moved, what is flagged, what is next. The written monthly document at the center of every fractional CMO seat, what goes in each section, why it is written instead of talked through, and how to tell when a brief has gone bad.",
    category: 'Fractional CMO',
  },
  {
    ...
    excerpt: "A consultant tells you what to do. A fractional CMO is responsible for whether it worked. The difference in accountability, where each one is the right call, five questions that sort it out, and the hybrid that usually works.",
    category: 'Fractional CMO',
  },
  {
  ...
  },
  {
    ...
    excerpt: "What a fractional CMO does for a hospitality brand, and why hospitality and wine companies hire one who has run the category instead of learning it on their budget. Kendall-Jackson, Resorts World, and a distributor's first marketing department.",
    category: 'Fractional CMO',
  },
  {
  ...
  },
  {
    ...
    excerpt: "How often should you update content for AEO? Monthly proof, quarterly FAQ audit, full refresh every 6 to 12 months. Here's the cadence and what to check first.",
    category: 'AI & Automation',
  },
  {
  ...
  },
  {
    ...
    excerpt: "What a restaurant franchise social media agency should cost, which services matter, and how multi-location groups should think about it. Proof: Blaze Pizza, a 10-year program from day zero to 300+ locations.",
    category: 'Restaurant',
  },
  {
  ...
  },
  {
    ...
    excerpt: "Alcohol influencer marketing has rules other categories do not. How wine and spirits brands pick creators, structure deals, stay compliant, and measure what matters, from 100+ creator deals.",
  ...
  },
  {
    ...
    excerpt: "How long does social media marketing take to work? Traction in 3 to 6 months, compounding by 9 to 12. Month-by-month timeline, how content and paid compare, and why quitting early costs the most.",
    category: 'Social Media Strategy',
  },
  {
  ...
  },
  {
    ...
    excerpt: "After managing social for 222+ brands across 12 verticals since 2008, certain patterns become undeniable. The principles that consistently separate real presence from burning budget.",
    category: 'Agency',
  },
  {
  ...
  },
  {
    ...
    excerpt: "How to choose a social media marketing agency: how many to pitch (three), what to look for, and the ten-point checklist we'd use on the other side of the table.",
    category: 'Agency',
  },
  {
