...
export const metadata: Metadata = {
  ...
  description:
    'Four senior-led practices on one AI-leveraged operating model. Retainers from $4,000 to $50K+/mo, the same senior team at every tier. 222+ brands since 2008.',
  alternates: {
...
const CORE_SERVICES = [
  ...
  },
  {
    ...
    tag: 'Retainer',
    body:
      'Meta, TikTok, and LinkedIn ad management for brands running $10,000+/mo in media. Management from $4,000/mo. Campaign strategy, creative direction, audience targeting, optimization, and transparent reporting. No hidden fees on ad spend.',
      ...
      <section className="container-edge py-24 md:py-32">
        ...
        <SimpleReveal delay={0.3}>
          <p className="mt-10 text-body text-text-secondary max-w-3xl leading-[1.7]">
            A growth retainer at $4,000/mo and an enterprise retainer at $50K+/mo do not run on
            different operating principles inside Fifty &amp; Five. They run on the same Senior + AI
            stack. The difference is volume, scope, and channel surface area.
          </p>
        </SimpleReveal>
        <SimpleReveal delay={0.36}>
          <p className="mt-5 text-body text-text-secondary max-w-3xl leading-[1.7]">
            Enterprise programs are scoped, not templated. Blaze Pizza ran as a ten-year national
            program from day zero to 300+ locations. Enterprise Holdings ran six brands across the
            US and LATAM.
          </p>
        </SimpleReveal>
      </section>
          ...
          __html: JSON.stringify({
            ...
            mainEntity: [
              ...
              },
              {
                ...
                acceptedAnswer: {
                  '@type': 'Answer',
                  text: 'Fifty & Five offers four retainer tiers: Growth ($4,000–$6,500/mo), Premium ($7,500–$12,000/mo), Scale ($15,000–$25,000/mo), and Enterprise ($30,000–$50,000+/mo). Every tier runs on the same Senior + AI operating model.',
                },
              },
            ],
          }),
